...
const InfiniteScroll = () => {
  return (
    <motion.section 
      className="py-16 overflow-hidden border-y border-border bg-black"
        ...
        <div className="flex whitespace-nowrap animate-scroll-x">
          {[...features, ...features].map((feature, index) => (
            ...
            >
              ...
              <div className="w-3 h-3 rounded-full mx-8 flex-shrink-0" style={{ background: 'var(--gradient-holographic)' }} />
            </div>
          ))}
        </div>
        ...
        <div className="flex whitespace-nowrap animate-scroll-x mt-8" style={{ animationDirection: 'reverse', animationDuration: '25s' }}>
          {Array(6).fill(complianceText).map((text, index) => (
            <div
              ...
              className="inline-flex items-center mx-8 flex-shrink-0"
            >
              <div className="w-2 h-2 rounded-full mx-6 flex-shrink-0" style={{ background: 'var(--gradient-holographic)' }} />
