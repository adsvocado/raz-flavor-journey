              ...
              >
                ...
                {isProductsOpen && (
                  <div className="absolute right-0 top-full pt-2 z-40">
                    <div className="w-48 bg-white/95 dark:bg-raz-black/95 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-white/10 shadow-xl py-2">
                      {productLinks.map((prod) => (
                        <Link
                          key={prod.name}
                          to={prod.href}
                          className="block px-4 py-3 text-sm text-raz-black dark:text-foreground hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
                        >
                          {prod.name}
                        </Link>
                      ))}
