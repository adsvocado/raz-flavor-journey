          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                ...
                {/* PANEL DEL DROPDOWN */}
                <div
                  className={`absolute top-full left-0 pt-2 transform transition-all duration-200 z-50 ${
                    isProductsOpen
                      ? "opacity-100 translate-y-0 pointer-events-auto"
                      : "opacity-0 -translate-y-1 pointer-events-none"
                  }`}
                >
                  <div className="rounded-2xl py-2 shadow-xl bg-white border border-black/5 min-w-[180px]">
