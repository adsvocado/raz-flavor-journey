...
const category = {
  ...
  strainType:
    "A curated set of three strains: one sativa, one hybrid, and one indica. Each preroll is infused with THCP diamonds and rich terpenes.",
  effects: [
  ...
  strainName:
    "Three signature strains chosen for standout flavor and consistent effects. A simple, premium lineup for customers who want reliable 1.5g THCP prerolls.",
  images: [
    alaskanThunderfuckBox,
    alienCookiesBox,
    strawberryKushBox,
    alaskanThunderfuckProducts,
    alienCookiesProducts,
    strawberryKushProducts,
    alaskanThunderfuckSingle,
    alienCookiesSingle,
    strawberryKushSingle,
  ],
};
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="font-poppins text-lg md:text-xl text-muted-foreground">
              THC-P Diamond Infused Pre-Rolls
            </p>
          </div>
